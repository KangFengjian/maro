...
It can be applied to many important industrial domains, such as [container inventory management(https://maro.readthedocs.io/en/v0.1/scenarios/container_inventory_management.html) 
in logistics, [bike repositioning](https://maro.readthedocs.io/en/v0.1/scenarios/citi_bike.html) 
in transportation, virtual machine provisioning in data centers, and asset management in finance. 
